                  ...
                  >
                    ...
                    <div className="flex flex-col w-full p-4">
                      <div className="flex items-center justify-between">
                        ...
                        <div>
                          <div className="flex items-center overflow-hidden h-7 px-2">
                            <span className="leading-sm font-bold text-2xl text-primary">{nft.price} ETH</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-row pt-4">
                        ...
                        <span className="flex-auto text-gray-400 leading-sm text-primary text-ellipsis overflow-hidden truncate whitespace-no-wrap w-32">
                          {nft.seller}
                        </span>
                      </div>
                  ...
                  <div className="rounded-xl ml-[-1px] rounded-b-default rounded-t-none">
                    <div className="">
                      <button
                        type="button"
                        onClick={() => buyNft(nft)}
                        className="inline-flex items-center justify-center whitespace-nowrap transition duration-200 text-md leading-md font-semibold bg-blue-500 text-white hover:bg-blue-2 gap-3 rounded-xl px-6 py-3 disabled:pointer-events-none disabled:opacity-40  w-full rounded-tl-none rounded-tr-none rounded-bl-none rounded-br-lg p-0"
                      >
                        <span className="text-sm leading-sm font-semibold text-white">
                          Buy now
                          <span></span>
                        </span>
                      </button>
